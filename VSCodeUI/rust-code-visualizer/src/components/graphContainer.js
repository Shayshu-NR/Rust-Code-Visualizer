...
function GraphContainer({ filesResults, programTarget }) {
    ...
    const setParentBtn2Click = (childBtn2Event) => {
        setBtn2Click(childBtn2Event);
    };
    const setParentBtn1Click = (childBtn3Event) => {
        setBtn1Click(childBtn3Event);
    };
    ...
    return (
        <div className="container mx-auto rounded-lg bg-gray-700 border-slate-600 font-mono">
            ...
            <Header 
                ...
                collapseState={containerCollapse}
            ></Header>
            ...
            <GraphBody 
                ...
                exportGraph={btn3Click}
                sortGraph={btn2Click}
                resetGraph={btn1Click}
            ></GraphBody>
            ...
            <GraphFooter
                ...
                keepButtons={true} 
                setParentBtn3Click={setParentBtn3Click}
                setParentBtn2Click={setParentBtn2Click}
                setParentBtn1Click={setParentBtn1Click}
            ></GraphFooter>
        </div>
    );
}
